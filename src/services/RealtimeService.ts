...
const EVENT_MAP: Record<string, string> = {
  ...
  "response.output_text.delta": "realtime:transcript_delta",
  "response.output_text.done": "realtime:transcript_done",
  "response.output_audio_transcript.delta": "realtime:audio_transcript_delta",
